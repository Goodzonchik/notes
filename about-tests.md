...
Старайтесь избегать большого количества аргументов. В статьях по рефакторингу 7 считается уже большим количеством. Чем больше аргументов, тем больше вариантов будет у на выходе метода, тем больше придется написать тестов, чтобы закрыть функционал.
