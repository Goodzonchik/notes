...
Навык писать тестируемый код приходит с опытом, но для этого нужно писать очень много тестов.
...
### 5. Обязательно выработайте договоренности по тому, как писать тесты.
